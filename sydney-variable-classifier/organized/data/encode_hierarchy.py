...
if __name__ == '__main__':
    ...
    parser.add_argument('--h_file', type=str, default='variability_hierarchy.txt', help='The input file specifying the hierarchy in indented tree format.')
    ...
    hierarchy = read_hierarchy(args.h_file)
